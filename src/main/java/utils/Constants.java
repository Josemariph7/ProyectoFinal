...
public class Constants {
    // Rutas FXML
    public static final String ITEM_ADMIN_LIST_FXML = "/fxml/ItemAdminList.fxml";
    public static final String LOGIN_FXML = "/fxml/LogIn.fxml";
    public static final String MODIFY_FXML = "/fxml/Modify.fxml";
    public static final String SIGNIN_FXML = "/fxml/SignIn.fxml";
    public static final String SIGNUP_FXML = "/fxml/SignUp.fxml";
    public static final String DASHBOARD_ADMIN_FXML = "/fxml/DashboardAdmin.fxml";
    public static final String DASHBOARD_STUDENT_FXML = "/fxml/DashboardStudent.fxml";
    public static final String DASHBOARD_OWNER_FXML = "/fxml/DashboardOwner.fxml";
    public static final String SPLASH_SCREEN_FXML = "/fxml/SplashScreen.fxml";
    public static final String DEFAULT_PROFILE_PICTURE = "/profilepictures/default.png";
